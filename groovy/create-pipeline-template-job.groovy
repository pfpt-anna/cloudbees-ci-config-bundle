...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/pfpt-anna/pipeline-template-catalog.git");
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>pfpt-anna</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/pfpt-anna/pipeline-template-catalog.git</repositoryUrl>
              <traits>
